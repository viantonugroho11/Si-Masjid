...
<head>
  ...
  <title>SiMasjid-Login Admin</title>
  <!-- plugins:css -->
          ...
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              <div class="brand-logo">
                <img src="{{ asset('assets/backend/images/Logo1.png') }}" alt="logo">
              </div>
              <h4>Ahlan Ustadz !</h4>
              <h6 class="font-weight-light">Silahkan masukkan nama pengguna dan kata sandi</h6>
              <form class="pt-3" method="POST" action="{{ route('login') }}">
                ...
                <div class="mt-3">
                  {{-- <a class="" href="../../index.html">Masuk</a> --}}
